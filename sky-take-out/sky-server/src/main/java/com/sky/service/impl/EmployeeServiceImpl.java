...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee login(EmployeeLoginDTO employeeLoginDTO) {
        ...
        //密码比对
        //Encrypt the cleartext password from front-end with MD5
    ...
    public void addEmployee(EmployeeDTO employeeDTO) {
        ...
        //Set default password as 123456 (after MD5 encryption)
        employee.setPassword(DigestUtils.md5DigestAsHex(PasswordConstant.DEFAULT_PASSWORD.getBytes()));

        //Set Create time and update time
        employee.setCreateTime(LocalDateTime.now());
        employee.setUpdateTime(LocalDateTime.now());
        //Set creator id and updater id
     ...
     *
     * @param employeeDTO
     * @return The number of successfully updated record
     */
    @Override
